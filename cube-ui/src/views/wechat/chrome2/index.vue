...
<el-dialog title="常用提示词" v-model="promptDialogVisible" width="60%" :close-on-click-modal="false">
  ...
  <template #default="scope">
    <el-button size="small" type="text" @click="usePrompt(scope.row)">
      <el-icon><Check /></el-icon> 使用
    </el-button>
    <el-button size="small" type="text" @click="handleEditPrompt(scope.row)">
      <el-icon><Edit /></el-icon> 修改
    </el-button>
    <el-button size="small" type="text" @click="handleDeletePrompt(scope.row)">
...
<script>
import { ChatDotSquare, Check, Delete, Document, Edit, Link, Loading, Plus, Promotion } from '@element-plus/icons-vue';
