...
import com.wx.fbsir.framework.business.potentialeye.service.WeWorkAuthService;
...
public class PotentialEyeAuthController {
    ...
    public void authorize(@RequestParam(value = "teamId", required = false) Long teamId,
        ...
        try {
            ...
            if (redirectUri == null || redirectUri.isBlank()) {
                ...
                //if (host.equals("localhost:8080") || host.equals("内网穿透")) host = "mcs.u3w.com"; 本地启动需要配置
    ...
    public void handleCallback(@RequestParam("code") String code,
        ...
        try {
            ...
            log.info("[授权] 登录成功 - userId: {}", result.getWeWorkUserId());
            //将这个信息存储在redis中
