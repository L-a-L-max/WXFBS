...
-- 日更助手菜单配置（放在内容管理下面）
-- =============================================
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `route_name`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2120, '日更助手', 2000, 10, 'daily-assistant', 'tool/dailyAssistant', '', '', 1, 0, 'C', '0', '0', 'wechat:daily:list', 'edit', 'admin', NOW(), '', NULL, '日更助手功能菜单');
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `route_name`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2121, '文章查询', 2120, 1, '#', NULL, '', '', 1, 0, 'F', '0', '0', 'wechat:daily:query', '#', 'admin', NOW(), '', NULL, '');
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `route_name`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2122, '文章新增', 2120, 2, '#', NULL, '', '', 1, 0, 'F', '0', '0', 'wechat:daily:add', '#', 'admin', NOW(), '', NULL, '');
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `route_name`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2123, '文章删除', 2120, 3, '#', NULL, '', '', 1, 0, 'F', '0', '0', 'wechat:daily:remove', '#', 'admin', NOW(), '', NULL, '');
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `route_name`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2124, '智能体配置', 2120, 4, '#', NULL, '', '', 1, 0, 'F', '0', '0', 'wechat:daily:config', '#', 'admin', NOW(), '', NULL, '');
