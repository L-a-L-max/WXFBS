...
- **服务器地址 (URL)**：如 `https://你的域名/api/v2/channel/callback/wecom/message/2006691440087115008`
- **Token**：消息验证Token
- **EncodingAESKey**：AES加密密钥（43位）

**⚠️ 重点**：记录URL中 `/message/` 后面的数字（如 `2006691440087115008`），这是channelId
...
yuanqi:
  ...
  target-url: https://yuanqi.tencent.com/api/v2/channel/callback/wecom/message/{channelId}
